<ul class="c-sidebar-nav">
    ...
    @can('manage users')
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link {{ request()->is("users/*") ? "c-active" : "" }}"
    ...
    @endcan
    <li class="c-sidebar-nav-item">
        <a class="c-sidebar-nav-link {{ request()->is("clients/*") ? "c-active" : "" }}"
    ...
    <li class="c-sidebar-nav-item">
        <a class="c-sidebar-nav-link {{ request()->is("projects/*") ? "c-active" : "" }}"
    ...
    <li class="c-sidebar-nav-item">
        <a class="c-sidebar-nav-link {{ request()->is("tasks/*") ? "c-active" : "" }}"
    ...
    <li class="c-sidebar-nav-item">
        <a href="#" class="c-sidebar-nav-link" onclick="event.preventDefault();
